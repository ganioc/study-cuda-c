...
/**
    concurrent operation in CUDA
    blocks in grid, concurrent tasks, no gurantee their order of execution, no synchronization
    warp in block, concurrent threads, explicitly synchronizable,
    thread in warp, implicit synchronized,
*/
